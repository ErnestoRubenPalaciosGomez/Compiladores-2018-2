...
%token SALTO OR WHILE NOT AND IF PRINT ELSE BOOLEANO ENTERO REAL IDENTIFICADOR  CADENA POW MENOR_IGUAL MAYOR_IGUAL DIVISION_ENTERA IGUAL_IGUAL DIFERENTE INDENTA DEINDENTA ELIF FOR

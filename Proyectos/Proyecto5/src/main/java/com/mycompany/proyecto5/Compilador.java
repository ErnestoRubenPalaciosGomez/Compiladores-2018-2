...
public class Compilador{
    ...
    public static void main(String[] args){
        String archivo = "src/main/resources/" + Compilador.NOMBRE_ARCHIVO + Compilador.EXTENCION_ARCHIVO;
        try{
